# Install and setup SOLECTRUS with ioBroker
...
```console
curl -L "https://raw.githubusercontent.com/solectrus/hosting/main/guide/mqtt-iobroker/.env" -o /home/pi/solectrus/.env
```
...
```console
curl -L "https://raw.githubusercontent.com/solectrus/hosting/main/guide/mqtt-iobroker/docker-compose.yml" -o /home/pi/solectrus/docker-compose.yml
```
